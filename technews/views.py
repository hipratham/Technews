...
def home(request):
    ...
    news_articles = TechNews.objects.all()[:3]
    ...
    topics = [
        {
            ...
            'prompt': """Generate a detailed technology news article about AI and innovation:
            Title: [Create an engaging title about recent AI breakthroughs]
            
            [Write 5-6 detailed paragraphs covering:
            1. A major AI breakthrough or discovery
            2. Technical details and methodology
            3. Industry impact and applications
            4. Expert opinions with specific quotes
            5. Future implications
            
            Use specific examples, statistics, and expert quotes. Make it engaging and informative.]"""
        },
        {
            'category': 'Tech Industry News',
            'prompt': """Generate a detailed technology industry news article:
            ...
            3. Competition and strategic moves
            4. Expert analysis and predictions
            5. Global impact and regional developments
            
            Include specific data points, market figures, and expert quotes.]"""
        },
        {
            'category': 'Future Tech Trends',
            'prompt': """Generate a forward-looking technology trends article:
            Title: [Create an engaging title about emerging tech trends]
            
            [Write 5-6 detailed paragraphs covering:
            1. Emerging technology trends
            2. Research and development breakthroughs
            3. Potential applications and use cases
            4. Industry expert predictions
            5. Timeline and adoption forecasts
            
            Focus on concrete examples, research findings, and expert insights.]"""
        }
    ]
        ...
        try:
            ...
            response = requests.post(
                ...
                json={
                    ...
                    "prompt": topic['prompt'],
                    "stream": False,
                    "temperature": 0.7,  # Add some creativity while keeping coherence
...
def _create_fallback_article(category):
    ...
    fallback_content = {
        'AI & Innovation': {
            'title': "AI Breakthrough: New Neural Networks Show Human-Like Learning",
